...
<gameSystem id="sys-783d-8aac-9dfc-917b" name="Blood Bowl" battleScribeVersion="2.03" revision="1" type="gameSystem" xmlns="http://www.battlescribe.net/schema/gameSystemSchema" library="true">
  ...
  <sharedSelectionEntryGroups>
    <selectionEntryGroup name="Agility" id="fcc9-3efe-db4e-206d" hidden="false">
      <selectionEntries>
        <selectionEntry type="upgrade" import="true" name="Catch (Active)" hidden="false" id="3cbf-9190-877a-dd8d">
          <infoLinks>
            <infoLink name="Catch (Active)" id="d5de-473e-da50-8f80" hidden="false" type="rule" targetId="098e-6fa4-284c-49ca"/>
          </infoLinks>
          <modifiers>
            <modifier type="append" value="Catch (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <constraints>
        ...
        <selectionEntry type="upgrade" import="true" name="Dodge (Active)" hidden="false" id="fd3f-cc07-9cc8-98ea">
          <infoLinks>
            <infoLink name="Dodge (Active)" id="37fd-6fab-965f-2991" hidden="false" type="rule" targetId="76b8-dd78-3edc-4b16"/>
          </infoLinks>
          <modifiers>
            <modifier type="append" value="Dodge (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="2f29-e00a-607c-3f20"/>
          </constraints>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Sidestep (Active)" hidden="false" id="fd16-5b77-2cb1-ae29">
          <infoLinks>
            <infoLink name="Sidestep (Active)" id="94d3-e162-fd89-0fc0" hidden="false" type="rule" targetId="f58b-2d8b-99e7-2b1c"/>
          </infoLinks>
          <modifiers>
            <modifier type="append" value="Side Step (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="58d9-e3a8-e060-4938"/>
          </constraints>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Diving Catch (Active)" hidden="false" id="a823-8e80-3fe9-3c57">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Diving Catch (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Diving Catch (Active)" id="0957-35f2-4b79-d7ec" hidden="false" type="rule" targetId="dd58-42b0-b6c5-2948"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Diving Tackle (Active)" hidden="false" id="7dcd-6431-83aa-45ee">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Diving Tackle (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Diving Tackle (Active)" id="0c87-efc0-58d2-35a3" hidden="false" type="rule" targetId="cd69-0caa-585b-3a39"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Defensive (Active)" hidden="false" id="2ff8-d21a-4569-a1a9">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Defensive (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Defensive (Active)" id="a102-7733-fd8d-60c3" hidden="false" type="rule" targetId="45b3-7be5-2c44-6ae1"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Hit and Run (Active)" hidden="false" id="d2d1-9a8f-c4a8-2f56">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Hit and Run (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Hit and Run (Active)" id="32f6-8277-1433-8f3a" hidden="false" type="rule" targetId="1517-e3ea-cdf2-c03f"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Jump Up (Active)" hidden="false" id="b06f-8bce-bfe3-fd7b">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Jump Up (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Jump Up (Active)" id="5dce-d6f5-684f-5cc6" hidden="false" type="rule" targetId="bddd-f778-43af-92d6"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Leap (Active)" hidden="false" id="45fc-f179-e755-23e4">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Leap (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Leap (Active)" id="9c63-ec4f-4bf3-3fc3" hidden="false" type="rule" targetId="ea91-91c0-9d4f-9828"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Safe Pair of Hands (Active)" hidden="false" id="8273-6297-5860-c1ce">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Safe Pair of Hands (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Safe Pair of Hands (Active)" id="db06-ffcf-bc50-32fb" hidden="false" type="rule" targetId="03c1-9b60-198b-adef"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Sure Feet (Active)" hidden="false" id="8de6-19d9-5b42-e667">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Sure Feet (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Sure Feet (Active)" id="64fb-eaf6-7083-a8b3" hidden="false" type="rule" targetId="57d4-9f23-820f-5564"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Sprint (Active)" hidden="false" id="be8c-ebf4-021c-1083">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Sprint (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
    ...
    <selectionEntryGroup name="Devious" id="d38f-5d99-694f-98b4" hidden="false">
      <selectionEntries>
        <selectionEntry type="upgrade" import="true" name="Sneaky Git (Active)" hidden="false" id="3714-b26f-77e9-86af">
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="3e44-a814-6ecf-0712"/>
          </constraints>
          <modifiers>
            <modifier type="append" value="Sneaky Git (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Sneaky Git (Active)" id="ae5a-dd0f-631e-849d" hidden="false" type="rule" targetId="55b8-f8cc-b103-d0a9"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Shadowing (Active)" hidden="false" id="9218-8f39-e528-6b51">
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="2936-e977-0838-5038"/>
          </constraints>
          <modifiers>
            <modifier type="append" value="Shadowing (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Shadowing (Active)" id="d903-2d00-1e87-c4a8" hidden="false" type="rule" targetId="5263-3b6c-910f-3a9d"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Dirty Player (Active)" hidden="false" id="92c5-858a-41fe-287b">
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="5378-4f81-4834-a456"/>
          </constraints>
          <modifiers>
            <modifier type="append" value="Dirty Player (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Dirty Player (Active)" id="abab-0bab-dcd3-3784" hidden="false" type="rule" targetId="b9d6-feed-f5da-6864"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Fumblerooskie (Active)" hidden="false" id="40a8-c55e-5a79-a956">
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="b48a-2e28-6b3a-4f03"/>
          </constraints>
          <modifiers>
            <modifier type="append" value="Fumblerooski (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Fumblerooski (Active)" id="6cb1-b844-21c2-b696" hidden="false" type="rule" targetId="d394-3589-41fd-686a"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Eye Gouge (Active)" hidden="false" id="38a5-ea0d-6d11-7ea8">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Eye Gouge (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Lethal Flight (Active)" hidden="false" id="e3a6-5677-ccf5-314f">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Lethal Flight (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Lone Fouler (Active)" hidden="false" id="24b5-d622-c54a-9fa0">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Lone Fouler (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Pile Driver (Active)" hidden="false" id="4d1b-180b-7d5c-d552">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Pile Driver (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Put the Boot In (Active)" hidden="false" id="db00-bea0-efd4-a74d">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Put the Boot In (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Quick Foul (Active)" hidden="false" id="3114-a4ca-3905-6327">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Quick Foul (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Saboteur (Active)" hidden="false" id="a473-ceb3-3a71-09d7">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Saboteur (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Violent Innovator (Active)" hidden="false" id="dfe8-5eb3-062f-beb0">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Violent Innovator (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
      </selectionEntries>
    </selectionEntryGroup>
    <selectionEntryGroup name="General" id="f7fd-b955-21d7-90d4" hidden="false">
      <selectionEntries>
        <selectionEntry type="upgrade" import="true" name="Block (Active)" hidden="false" id="0e89-4745-7902-b155">
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="f4cb-6098-e0b0-a49d"/>
          </constraints>
          <modifiers>
            <modifier type="append" value="Block (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Block (Active)" id="e6f0-8f1e-fa53-761a" hidden="false" type="rule" targetId="85b4-cdee-1e19-3038"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Sure Hands (Active)" hidden="false" id="27b1-e9c4-d427-d2d8">
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="014f-7f22-d1a1-d4ff"/>
          </constraints>
          <modifiers>
            <modifier type="append" value="Sure Hands (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Sure Hands (Active)" id="91be-6c62-b7fa-2b3c" hidden="false" type="rule" targetId="ff07-cb36-b759-cfa7"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Dauntless (Active)" hidden="false" id="4d11-85d3-4e6b-2ca1">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Dauntless (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Fend (Active)" hidden="false" id="53f7-15ef-fbe0-9031">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Fend (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Frenzy* (Active)" hidden="false" id="174f-5c4a-d02f-096e">
          <constraints>
          ...
          <infoLinks>
            <infoLink name="Frenzy* (Active)" id="d3d6-36a0-8ee2-b026" hidden="false" type="rule" targetId="23bd-8f90-1641-a278"/>
          </infoLinks>
          <modifiers>
            <modifier type="append" value="Frenzy* (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Kick (Active)" hidden="false" id="9d54-cb56-52d0-f34c">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Kick (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Pro (Active)" hidden="false" id="c01a-f957-98ac-92b5">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Pro (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Steady Footing (Active)" hidden="false" id="09ba-cd46-c151-4e45">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Steady Footing (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Strip Ball (Active)" hidden="false" id="8af2-7a8b-ed7d-8a54">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Strip Ball (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Tackle (Active)" hidden="false" id="730f-16ec-313f-88ce">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Tackle (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Taunt (Active)" hidden="false" id="6c98-ff99-b9c8-73f9">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Taunt (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Wrestle (Active)" hidden="false" id="a648-03ec-727a-921a">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Wrestle (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
      </selectionEntries>
    </selectionEntryGroup>
    <selectionEntryGroup name="Mutation" id="cc5f-a16a-3abc-1266" hidden="false">
      <selectionEntries>
        <selectionEntry type="upgrade" import="true" name="Claws (Passive)" hidden="false" id="e82b-325f-56c3-ff73">
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="d216-ebe2-d021-57d5"/>
          </constraints>
          <modifiers>
            <modifier type="append" value="Claws (Passive)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Claws (Passive)" id="9ddf-12e2-ba38-073c" hidden="false" type="rule" targetId="6f08-6919-3fb4-77b1"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Iron Hard Skin (Passive)" hidden="false" id="1f07-b511-b363-615b">
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="5f1a-a6be-8c06-5dd5"/>
          </constraints>
          <modifiers>
            <modifier type="append" value="Iron Hard Skin (Passive)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Iron Hard Skin (Passive)" id="dd43-90be-5d0a-d92d" hidden="false" type="rule" targetId="cd02-03fb-ff2b-a74a"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Big Hand (Active)" hidden="false" id="576a-494c-763f-491b">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Big Hand (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Disturbing Presence* (Active)" hidden="false" id="6f4e-09ba-73c2-9fcc">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Disturbing Presence* (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Extra Arms (Active)" hidden="false" id="90ad-773b-73fe-9902">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Extra Arms (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Foul Appearance* (Passive)" hidden="false" id="07a8-cbbc-5267-9a61">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Foul Appearance* (Passive)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Horns (Active)" hidden="false" id="b392-9974-2af9-bcf0">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Horns (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Monstrous Mouth (Active)" hidden="false" id="81e3-bd29-a700-e5b6">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Monstrous Mouth (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Prehensile Tail (Active)" hidden="false" id="285a-a4da-1ac5-8ba1">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Prehensile Tail (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Tentacles (Active)" hidden="false" id="e774-3a70-5f83-8a6e">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Tentacles (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Two Heads (Active)" hidden="false" id="87d5-dd94-021a-691b">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Two Heads (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Very Long Legs (Active)" hidden="false" id="17b5-6c5d-3794-9317">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Very Long Legs (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
      </selectionEntries>
    </selectionEntryGroup>
    <selectionEntryGroup name="Passing" id="20e9-6c45-24be-0559" hidden="false">
      <selectionEntries>
        <selectionEntry type="upgrade" import="true" name="Nerves of Steel (Active)" hidden="false" id="1828-768a-3a55-4675">
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="b03d-84db-2b40-a288"/>
          </constraints>
          <modifiers>
            <modifier type="append" value="Nerves of Steel (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Nerves of Steel (Active)" id="3c72-5a61-3cff-389c" hidden="false" type="rule" targetId="b7d6-484c-fffd-8eb4"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Pass (Active)" hidden="false" id="ee13-527f-f1cd-c4ca">
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="81de-7199-88db-4cae"/>
          </constraints>
          <modifiers>
            <modifier type="append" value="Pass (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Pass (Active)" id="9d42-7aaf-8694-5b06" hidden="false" type="rule" targetId="5149-08e1-df59-78bd"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Accurate (Active)" hidden="false" id="1d6e-be4a-d140-6695">
          <constraints>
            <constraint type="max" value="1" field="selections" scope="parent" shared="true" id="afab-a9da-2206-ea23"/>
          </constraints>
          <modifiers>
            <modifier type="append" value="Accurate (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Accurate (Active)" id="1b60-c050-a4c9-b742" hidden="false" type="rule" targetId="74e5-41fe-b941-88de"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Cannoneer (Active)" hidden="false" id="df74-83b9-476e-eb0e">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Cannoneer (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Cloud Burster (Active)" hidden="false" id="32dd-25fd-d3a2-9ab7">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Cloud Burster (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Dump-off (Active)" hidden="false" id="3333-d806-7584-c8e8">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Dump-off (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Give and Go (Active)" hidden="false" id="205d-9b3b-37b2-4470">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Give and Go (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Hail Mary Pass (Active)" hidden="false" id="15f5-63ee-9cdf-76a6">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Hail Mary Pass (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Leader (Passive)" hidden="false" id="233e-b79b-0792-69d3">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Leader (Passive)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="On the Ball (Active)" hidden="false" id="a279-db7f-7aab-d126">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="On the Ball (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Punt (Active)" hidden="false" id="fc98-60bc-7bb6-4794">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Punt (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Safe Pass (Active)" hidden="false" id="92fa-d3e4-5627-dce4">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Safe Pass (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
      </selectionEntries>
    </selectionEntryGroup>
    <selectionEntryGroup name="Strength" id="31a8-34bd-4d79-5269" hidden="false">
      <selectionEntries>
        <selectionEntry type="upgrade" import="true" name="Guard (Active)" hidden="false" id="0910-705f-ca61-c255">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Guard (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Guard (Active)" id="b4d2-eba8-895f-1f02" hidden="false" type="rule" targetId="6772-a834-2b47-9255"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Stand Firm (Active)" hidden="false" id="d009-274e-d212-e2df">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Stand Firm (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
          <infoLinks>
            <infoLink name="Stand Firm (Active)" id="d974-d128-37ce-6a91" hidden="false" type="rule" targetId="b299-5d1e-b26c-cd3b"/>
          </infoLinks>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Mighty Blow (Active)" hidden="false" id="b7af-e07f-efc9-8aa4">
          <infoLinks>
          ...
          <modifiers>
            <modifier type="append" value="Mighty Blow (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Arm Bar (Active)" hidden="false" id="cbe1-6acd-9485-681c">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Arm Bar (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Brawler (Active)" hidden="false" id="9256-339d-7987-49c4">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Brawler (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Break Tackle (Active)" hidden="false" id="bf76-6fef-b1a1-34c8">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Break Tackle (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Bullseye (Active)" hidden="false" id="e3a7-b9ce-e83c-bea7">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Bullseye (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Grab (Active)" hidden="false" id="ec3a-6308-b916-8e0b">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Grab (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Juggernaut (Active)" hidden="false" id="fb62-3fc9-f728-bf0c">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Juggernaut (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Multiple Block (Active)" hidden="false" id="ebf5-a871-3b99-91da">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Multiple Block (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Strong Arm (Active)" hidden="false" id="9bbc-0b62-5ed8-c316">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Strong Arm (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
        <selectionEntry type="upgrade" import="true" name="Thick Skull (Active)" hidden="false" id="3d15-f50c-c6e3-17e9">
          <constraints>
          ...
          <modifiers>
            <modifier type="append" value="Thick Skull (Active)" field="a256-4228-5691-a7d4" scope="root-entry" affects="69f8-eb37-db8c-47de.profiles.Player" join=", "/>
          </modifiers>
        </selectionEntry>
      </selectionEntries>
    </selectionEntryGroup>
